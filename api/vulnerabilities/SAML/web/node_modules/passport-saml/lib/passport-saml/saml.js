...
var InMemoryCacheProvider = require('passport-saml/lib/passport-saml/inmemory-cache-provider.js').CacheProvider;
var Q = require('q');
...
SAML.prototype.validatePostResponse = function (container, callback) {
  ...
  .then(function() {
    ...
    if (self.options.cert && 
      self.validateSignature(xml, doc.documentElement, self.options.cert)) {
      validSignature = true;
    }
